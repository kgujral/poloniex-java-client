...
public class PoloniexLendingService implements LendingService {
   ...
   */
  @Override
  public PoloniexLendingResult createLoanOffer(String currency, BigDecimal amount, BigDecimal lendingRate, int duration,
      boolean autoRenew) {
    long start = System.currentTimeMillis();
  ...
  public List<PoloniexLoanOffer> returnOpenLoanOffers(String currency) {
    long start = System.currentTimeMillis();
    List<PoloniexLoanOffer> offers = Collections.emptyList();
    try {
