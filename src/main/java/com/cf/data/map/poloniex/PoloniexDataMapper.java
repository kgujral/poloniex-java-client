...
public class PoloniexDataMapper {
  ...
  public List<PoloniexChartData> mapChartData(String chartDataResult) {
    ...
    if (INVALID_CHART_DATA_DATE_RANGE_RESULT.equals(chartDataResult)
        || INVALID_CHART_DATA_CURRENCY_PAIR_RESULT.equals(chartDataResult)) {
  ...
  public Map<String, PoloniexCompleteBalance> mapCompleteBalanceResultForNonZeroCurrencies(
      String completeBalanceResults) {
    return mapCompleteBalanceResult(completeBalanceResults).entrySet().stream()
  ...
  public PoloniexCompleteBalance mapCompleteBalanceResultForCurrency(String currencyType,
      String completeBalanceResults) {
  ...
  public List<PoloniexLendingHistory> mapLendingHistory(String lendingHistoryResults) {
    List<PoloniexLendingHistory> lendingHistory = gson.fromJson(lendingHistoryResults,
        new TypeToken<List<PoloniexLendingHistory>>() {
        }.getType());
  ...
  public List<PoloniexLoanOffer> mapOpenLoanOffers(String currency, String results) {
    ...
    Map<String, List<PoloniexLoanOffer>> offers = gson.fromJson(results,
        new TypeToken<Map<String, List<PoloniexLoanOffer>>>() {
        }.getType());
  ...
  public PoloniexOrderBook mapOrderBook(String orderResult) {
    PoloniexOrderBook orderBook = gson.fromJson(orderResult, new TypeToken<PoloniexOrderBook>() {
    }.getType());
    return orderBook;
  }
